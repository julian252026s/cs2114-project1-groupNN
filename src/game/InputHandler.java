...
// -------------------------------------------------------------------------
/**
 *  InputHandler class handles all player input and validates it to work with the rest of the game code
 * 
 *  @author Ari Bajaj
 *  @version Sep 23, 2026
 */
public class InputHandler
{
     ...
     * @param input - a command that the player inputs
    ...
    public String validateCommand(String input) {
        ...
        String commandWord = normalizedInput.split("\\s+")[0];
    ...
    public boolean isValidCommand(String command) {
        ...
        return allowedCommands.contains(command.toUpperCase());
    }
