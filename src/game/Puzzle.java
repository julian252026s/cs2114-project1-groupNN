...
public class Puzzle
{
     ...
     * @param answer - the puzzle answer
     * @param hint - a hint to solving the puzzle
     */
     ...
     * @param playerAnswer - answer that the player has entered
     * @return true if the player entered the right answer and sets the puzzle to solved, false if not
     */
